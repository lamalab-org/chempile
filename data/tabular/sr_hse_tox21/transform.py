...
def get_and_transform_data():
    ...
    target_subfolder = f"{label_list[9]}"
    ...
    # create meta yaml
    meta = {
        "name": "sr_hse_tox21",  # unique identifier, we will also use this for directory names
        ...
        "targets": [
            {
                ...
                "names": [  # names for the property (to sample from for building the prompts)
                    ...
                    {"noun": "SR-Heat shock response toxicity"},
                    {"noun": "Heat shock response toxicity"},
                    {"verb": f"shows {target_subfolder} toxicity"},
                    {"verb": "is active in the SR-Heat shock response toxicity assay"},
                    {"verb": "is active in the Heat shock response toxicity assay"},
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {toxicity_SR-HSE#not &NULL}{toxicity_SR-HSE__names__adjective}: {SMILES#}""",  # noqa: E501
            ...
            "Is the {SMILES__description} {SMILES#} {toxicity_SR-HSE__names__adjective}:<EOI>{toxicity_SR-HSE#no&yes}",  # noqa: E501 for the benchmarking setup <EOI>separates input and output
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_SR-HSE__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
