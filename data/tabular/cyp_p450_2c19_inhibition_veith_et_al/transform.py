...
def get_and_transform_data():
    ...
    meta = {
        "name": "cyp_p450_2c19_inhibition_veith_et_al",  # unique identifier, we will also use this for directory names
        "description": """The CYP P450 genes are essential in the breakdown (metabolism) of
