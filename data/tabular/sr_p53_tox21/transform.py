...
def get_and_transform_data():
    ...
    target_subfolder = f"{label_list[11]}"
    ...
    # create meta yaml
    meta = {
        "name": "sr_p53_tox21",  # unique identifier, we will also use this for directory names
        ...
        "targets": [
            {
                ...
                "names": [  # names for the property (to sample from for building the prompts)
                    ...
                    {"noun": "SR-p53 response toxicity"},
                    {"noun": "p53 response toxicity"},
                    {"verb": f"is active in the {target_subfolder} toxicity assay"},
                    {"verb": "is active in the SR-p53 response toxicity assay"},
                    {"verb": "is active in the p53 response toxicity assay"},
...
journal = {Frontiers in Environmental Science}""",
        ...
        "templates": [
            ...
            "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__gerund}.",  # noqa: E501
...
Result: {toxicity_SR-p53#False&True}""",  # noqa: E501
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_SR-p53__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result: This molecule is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}.""",
            """Task: Please {#give me|create|generate!} a {#molecule |!}{SMILES__description} based on the {#text |!}description{# below|!}.
Description: A molecule that is {toxicity_SR-p53__names__adjective}.
Result: {SMILES#}""",  # noqa: E501
            # Conversational text templates
            """User: Can you {#tell me|figure out|estimate!} if the molecule with the {SMILES__description} {SMILES#} is {toxicity_SR-p53__names__adjective}?
Assistant: {toxicity_SR-p53#No&Yes}, this molecule is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}.""",  # noqa: E501
            """User: Is the molecule with the {SMILES__description} {SMILES#} {toxicity_SR-p53__names__adjective}?
Assistant: {toxicity_SR-p53#No&Yes}, it is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}.""",  # noqa: E501
            """User: Can you {#give me|create|generate!} the {SMILES__description} of a molecule that is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}?
Assistant: {#Yes|Of course|Sure|Yes, I'm happy to help!}, here you go: {SMILES#}""",  # noqa: E501
            """User: I'm {#searching|looking!} for the {SMILES__description} of a molecule that is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}?
Assistant: This is a molecule that is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}: {SMILES#}""",  # noqa: E501
...
User: Yes, please. The molecule should {toxicity_SR-p53#not &NULL}be {toxicity_SR-p53__names__adjective}.
Assistant: {#Ok|Got it!},{# here you go,|!} this {SMILES__description} is {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}: {SMILES#}""",  # noqa: E501
            """User: I want to {#come up with|create|generate!} a {#molecule |!}{SMILES__description}.
...
Result:<EOI>{toxicity_SR-p53#False&True}""",  # noqa: E501
            """Task: Please {#give me|create|generate!} a {#molecule |!}{SMILES__description} based on the {#text |!}description{# below|!}.
Description: A molecule that is {toxicity_SR-p53__names__adjective}.
Result:<EOI>{SMILES#}""",  # noqa: E501
            """Task: Please answer the multiple choice question.
Question: Is the molecule with the {SMILES__description} {#representation of |!}{SMILES#} {toxicity_SR-p53__names__adjective}?
...
Answer:<EOI>{%multiple_choice_result}""",  # noqa: E501
            """Task: Please answer the multiple choice question.
Question: Which molecules are {toxicity_SR-p53#not &NULL}{toxicity_SR-p53__names__adjective}?
