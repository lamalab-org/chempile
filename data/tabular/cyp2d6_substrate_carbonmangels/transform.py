...
def get_and_transform_data():
    ...
    meta = {
        "name": "cyp2d6_substrate_carbonmangels",  # unique identifier, we will also use this for directory names
        "description": """CYP2D6 is primarily expressed in the liver. It is also highly expressed
...
esult: {CYP2D6_Substrate#False&True}""",  # noqa: E501
            """Task: Please classify a molecule based on the description.
...
Assistant: {CYP2D6_Substrate#No&Yes}, this molecule is {CYP2D6_Substrate#not &NULL}{CYP2D6_Substrate__names__verb}.""",  # noqa: E501
            """User: Is the molecule with the {SMILES__description} {SMILES#} {CYP2D6_Substrate__names__verb}?
Assistant: {CYP2D6_Substrate#No&Yes}, it is {CYP2D6_Substrate#not &NULL}a {CYP2D6_Substrate__names__noun}.""",  # noqa: E501
...
Assistant: This is a molecule that is {CYP2D6_Substrate#not &NULL}a {CYP2D6_Substrate__names__noun}: {SMILES#}""",  # noqa: E501
...
Assistant: {#Ok|Got it!},{# here you go,|!} this {SMILES__description} is {CYP2D6_Substrate#not &NULL}{CYP2D6_Substrate__names__verb}: {SMILES#}""",  # noqa: E501
            """User: I want to {#come up with|create|generate!} a {#molecule |!}{SMILES__description}.
...
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{CYP2D6_Substrate#False&True}""",  # noqa: E501
