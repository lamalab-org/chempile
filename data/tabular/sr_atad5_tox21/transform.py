...
def get_and_transform_data():
    ...
    df["toxicity_SR-ATAD5"] = df["toxicity_SR-ATAD5"].astype(int)
        ...
        "targets": [
            {
                ...
                "names": [  # names for the property (to sample from for building the prompts)
                    ...
                    {
                        "verb": "is active in the Luciferase-tagged ATAD5 in human embryonic kidney cells toxicity assay"  # noqa
                    },
...
Description: A molecule that is {toxicity_SR-ATAD5__names__adjective}.
...
Result: {toxicity_SR-ATAD5#False&True}""",  # noqa: E501
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_SR-ATAD5__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Answer the question in a {#full|complete!} sentence.
Result: This molecule is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}.""",
            """Task: Please {#give me|create|generate!} a {#molecule |!}{SMILES__description} based on the {#text |!}description{# below|!}.
Description: A molecule that is {toxicity_SR-ATAD5__names__adjective}.
Result: {SMILES#}""",  # noqa: E501
            # Conversational text templates
            """User: Can you {#tell me|figure out|estimate!} if the molecule with the {SMILES__description} {SMILES#} is {toxicity_SR-ATAD5__names__adjective}?
Assistant: {toxicity_SR-ATAD5#No&Yes}, this molecule is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}.""",  # noqa: E501
            """User: Is the molecule with the {SMILES__description} {SMILES#} {toxicity_SR-ATAD5__names__adjective}?
Assistant: {toxicity_SR-ATAD5#No&Yes}, it is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}.""",  # noqa: E501
            """User: Can you {#give me|create|generate!} the {SMILES__description} of a molecule that is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}?
Assistant: {#Yes|Of course|Sure|Yes, I'm happy to help!}, here you go: {SMILES#}""",  # noqa: E501
            """User: I'm {#searching|looking!} for the {SMILES__description} of a molecule that is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}?
Assistant: This is a molecule that is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}: {SMILES#}""",  # noqa: E501
...
User: Yes, please. The molecule should {toxicity_SR-ATAD5#not &NULL}be {toxicity_SR-ATAD5__names__adjective}.
Assistant: {#Ok|Got it!},{# here you go,|!} this {SMILES__description} is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}: {SMILES#}""",  # noqa: E501
            """User: I want to {#come up with|create|generate!} a {#molecule |!}{SMILES__description}.
Assistant: {#This sounds very exciting. |This sounds very interesting. !}Should it be a special {#molecule|one!}?
User: Yes, the molecule should {toxicity_SR-ATAD5#not &NULL}be {toxicity_SR-ATAD5__names__adjective}.
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}: {SMILES#}""",  # noqa: E501
            # Benchmarking text templates
            "Is the {SMILES__description} {SMILES#} {toxicity_SR-ATAD5__names__adjective}:<EOI>{toxicity_SR-ATAD5#no&yes}",  # noqa: E501 for the benchmarking setup <EOI>separates input and output
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_SR-ATAD5__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{toxicity_SR-ATAD5#False&True}""",  # noqa: E501
            """Task: Please {#give me|create|generate!} a {#molecule |!}{SMILES__description} based on the {#text |!}description{# below|!}.
Description: A molecule that is {toxicity_SR-ATAD5__names__adjective}.
Result:<EOI>{SMILES#}""",  # noqa: E501
            """Task: Please answer the multiple choice question.
Question: Is the molecule with the {SMILES__description} {#representation of |!}{SMILES#} {toxicity_SR-ATAD5__names__adjective}?
...
Answer:<EOI>{%multiple_choice_result}""",  # noqa: E501
            """Task: Please answer the multiple choice question.
Question: Which molecules are {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}?
Constraint: You must select none, one or more options from {%multiple_choice_enum%2-5%aA1} without using any {#other|additional!} words.
Options:
{SMILES%toxicity_SR-ATAD5%}
Answer: {%multiple_choice_result}""",  # noqa: E501
            """Task: Please answer the multiple choice question.
Question: Which molecules are {toxicity_SR-ATAD5#not &NULL}{toxicity_SR-ATAD5__names__adjective}?
Constraint: You must select none, one or more options from {%multiple_choice_enum%2-5%aA1} without using any {#other|additional!} words.
