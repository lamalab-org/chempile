...
journal = {Journal of Chemical Information and Modeling}""",
        ...
        "templates": [
            "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} is {CYP3A4_Substrate#not &NULL}a {CYP3A4_Substrate__names__noun}.",  # noqa: E501
            "Based on the {SMILES__description} {#representation |!}{SMILES#}, the molecule is {CYP3A4_Substrate#not &NULL}{CYP3A4_Substrate__names__verb}.",  # noqa: E501
            "The {SMILES__description} {SMILES#} represents a molecule that is {CYP3A4_Substrate#not &NULL}identified as a {CYP3A4_Substrate__names__noun}.",  # noqa: E501
            "The {#molecule |!}{SMILES__description} {SMILES#} is {CYP3A4_Substrate#not &NULL}{CYP3A4_Substrate__names__verb}.",  # noqa: E501 not all variables need to be used
            # Instruction tuning text templates
            """Task: Please classify a molecule based on the description.
Description: A molecule that is a {CYP3A4_Substrate__names__noun}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
esult: {CYP3A4_Substrate#False&True}""",  # noqa: E501
            """Task: Please classify a molecule based on the description.
...
Assistant: {CYP3A4_Substrate#No&Yes}, this molecule is {CYP3A4_Substrate#not &NULL}{CYP3A4_Substrate__names__verb}.""",  # noqa: E501
            """User: Is the molecule with the {SMILES__description} {SMILES#} {CYP3A4_Substrate__names__verb}?
Assistant: {CYP3A4_Substrate#No&Yes}, it is {CYP3A4_Substrate#not &NULL}a {CYP3A4_Substrate__names__noun}.""",  # noqa: E501
...
Assistant: This is a molecule that is {CYP3A4_Substrate#not &NULL}a {CYP3A4_Substrate__names__noun}: {SMILES#}""",  # noqa: E501
...
Assistant: {#Ok|Got it!},{# here you go,|!} this {SMILES__description} is {CYP3A4_Substrate#not &NULL}{CYP3A4_Substrate__names__verb}: {SMILES#}""",  # noqa: E501
            """User: I want to {#come up with|create|generate!} a {#molecule |!}{SMILES__description}.
Assistant: {#This sounds very exciting. |This sounds very interesting. !}Should it be a special {#molecule|one!}?
User: Yes, the molecule should {CYP3A4_Substrate#not &NULL}be a {CYP3A4_Substrate__names__noun}.
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {CYP3A4_Substrate#not &NULL}a {CYP3A4_Substrate__names__noun}: {SMILES#}""",  # noqa: E501
            # Benchmarking text templates
            "Is the {SMILES__description} {SMILES#} a {CYP3A4_Substrate__names__noun}:<EOI>{CYP3A4_Substrate#no&yes}",  # noqa: E501 for the benchmarking setup <EOI>separates input and output
            """Task: Please classify a molecule based on the description.
Description: A molecule that is a {CYP3A4_Substrate__names__noun}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{CYP3A4_Substrate#False&True}""",  # noqa: E501
