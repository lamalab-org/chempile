...
def get_and_transform_data():
    ...
    target_subfolder = f"{label_list[3]}"
    ...
    df["toxicity_NR-Aromatase"] = df["toxicity_NR-Aromatase"].astype(int)
    df.to_csv(fn_data_csv, index=False)

    # create meta yaml
    meta = {
        "name": "nr_aromatase_tox21",  # unique identifier, we will also use this for directory names
...
journal = {Frontiers in Environmental Science}""",
        ...
        "templates": [
            "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__adjective}.",  # noqa: E501
            "The molecule with the {SMILES__description} {#representation of |!}{SMILES#} is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__gerund}.",  # noqa: E501
            "Based on the {SMILES__description} {#representation |!}{SMILES#}, the molecule has {toxicity_NR-Aromatase#no &NULL}{toxicity_NR-Aromatase__names__noun} {#properties|characteristics|features!}.",  # noqa: E501
            "The {SMILES__description} {SMILES#} {#represents|is from!} a molecule that is {toxicity_NR-Aromatase#not &NULL}identified as {toxicity_NR-Aromatase__names__adjective}.",  # noqa: E501
            "The {#molecule |!}{SMILES__description} {SMILES#} is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__adjective}.",  # noqa: E501 not all variables need to be used
...
Result: {toxicity_NR-Aromatase#False&True}""",  # noqa: E501
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_NR-Aromatase__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
...
Assistant: {toxicity_NR-Aromatase#No&Yes}, this molecule is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__adjective}.""",  # noqa: E501
            """User: Is the molecule with the {SMILES__description} {SMILES#} {toxicity_NR-Aromatase__names__adjective}?
Assistant: {toxicity_NR-Aromatase#No&Yes}, it is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__adjective}.""",  # noqa: E501
...
Assistant: This is a molecule that is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__adjective}: {SMILES#}""",  # noqa: E501
...
Assistant: {#Ok|Got it!},{# here you go,|!} this {SMILES__description} is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__adjective}: {SMILES#}""",  # noqa: E501
            """User: I want to {#come up with|create|generate!} a {#molecule |!}{SMILES__description}.
...
Assistant: {#Understood|Got it|Ok!}, this {SMILES__description} is {toxicity_NR-Aromatase#not &NULL}{toxicity_NR-Aromatase__names__adjective}: {SMILES#}""",  # noqa: E501
            # Benchmarking text templates
            "Is the {SMILES__description} {SMILES#} {toxicity_NR-Aromatase__names__adjective}:<EOI>{toxicity_NR-Aromatase#no&yes}",  # noqa: E501 for the benchmarking setup <EOI>separates input and output
            """Task: Please classify a molecule based on the description.
Description: A molecule that is {toxicity_NR-Aromatase__names__adjective}.
{#Molecule |!}{SMILES__description}: {SMILES#}
Constraint: Even if you are {#uncertain|not sure!}, you must pick either "True" or "False" without using any {#other|additional!} words.
Result:<EOI>{toxicity_NR-Aromatase#False&True}""",  # noqa: E501
            """Task: Please {#give me|create|generate!} a {#molecule |!}{SMILES__description} based on the {#text |!}description{# below|!}.
Description: A molecule that is {toxicity_NR-Aromatase__names__adjective}.
